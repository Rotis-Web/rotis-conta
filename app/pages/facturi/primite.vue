    ...
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2 md:order-1">
          <DocumentsList tip="factura-primita" :year="selectedYear" />
        </div>
      </div>
    </div>
...
const handleUploadSuccess = () => {
  documentsStore.fetchDocuments("factura-primita", true);
};

onMounted(async () => {
  try {
    await documentsStore.fetchDocuments("factura-primita");
  } catch (error) {
