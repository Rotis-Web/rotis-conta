  ...
  <div class="space-y-6">
    <div class="bg-white rounded-lg shadow p-6">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl md:text-2xl font-bold text-gray-900">Diverse</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <UploadDocument tip="divers" @success="handleUploadSuccess" />
        </div>
...
const handleUploadSuccess = () => {
  documentsStore.fetchDocuments("divers", true);
};

onMounted(async () => {
  try {
    await documentsStore.fetchDocuments("divers");
  } catch (error) {
