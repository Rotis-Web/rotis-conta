  ...
  <div class="space-y-6">
    <div class="bg-white rounded-lg shadow p-6">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl md:text-2xl font-bold text-gray-900">Contracte</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <UploadDocument tip="contract" @success="handleUploadSuccess" />
        </div>
        <div class="md:col-span-2 md:order-1">
          <DocumentsList tip="contract" :year="selectedYear" />
        </div>
      </div>
    </div>
